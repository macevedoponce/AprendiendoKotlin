...
class CategoriesViewHolder(view:View) : RecyclerView.ViewHolder(view){
    ...
    fun render(taskCategory: TaskCategory, onItemSelected: (Int) -> Unit){ //función lambda

        val color = if(taskCategory.isSelected){R.color.todo_background_card}else{R.color.todo_background_disable}
